...
public class PlayerSprintAndCrouch : MonoBehaviour
{
    ...
    private Transform player_Perspective;
    ...
    void Awake()
    {
        ...
        player_Perspective = transform.GetChild(0);
    ...
    void Crouch()
    {
        ...
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            if (is_Crouching)
            {
                ...
                player_Perspective.localPosition = new Vector3(0f, stand_Height, 0f);
                playerMovement.speed = move_Speed;
            ...
            else
            {
                ...
                player_Perspective.localPosition = new Vector3(0f, crouch_Height, 0f);
