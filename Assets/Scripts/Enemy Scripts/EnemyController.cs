...
public class EnemyController : MonoBehaviour
{
    ...
    public GameObject attack_PointR, attack_PointL;
    ...
    void Turn_On_AttackPointR()
    {
        attack_PointR.SetActive(true);
    }

    void Turn_Off_AttackPointR()
    {
        if (attack_PointR.activeInHierarchy)
        {
            attack_PointR.SetActive(false);
        }
    }

    void Turn_On_AttackPointL()
    {
        attack_PointL.SetActive(true);
    }

    void Turn_Off_AttackPointL()
    {
        if (attack_PointL.activeInHierarchy)
        {
            attack_PointL.SetActive(false);
        }
    }
